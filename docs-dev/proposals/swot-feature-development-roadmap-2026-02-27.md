...
- [ ] `FR-04-T03` Add weapon selection heuristics and situational item use.
  ...
  records split health/armor deltas with a sequence guard, and status markers
  expose estimate state for future weapon-selection consumers.
