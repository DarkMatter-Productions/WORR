#!/usr/bin/env python3
"""Regression checks for the fogged unlightmapped inline-BSP fixture."""
...
import generate_bmodel_instance_fog_fixture as fixture


class FoggedUnlightmappedBmodelInstanceFixtureTests(unittest.TestCase):
