#!/usr/bin/env python3
"""Generate a fogged dense inline-BSP grid without authored lightmaps."""
...
MAP_NAME = "worr_fr01_bmodel_instances_fog.bsp"
...
def main() -> int:
    ...
    report = {
        "schema": "worr.renderer-parity.bmodel-instance-fog-fixture.v1",
    ...
    print(
        ...
        f"{len(outputs)} fogged unlightmapped bmodel-instancing fixture output(s)"
    )
    return 0
