...
class VulkanGpuMd5SubmissionSourceTests(unittest.TestCase):
    ...
    def test_per_frame_instance_palette_streams_and_descriptor_set_are_bound(self) -> None:
        ...
        self.assertIn("frame->md5_instance_upload_bytes = md5_instance_bytes", VK_ENTITY)
        self.assertIn("frame->md5_palette_upload_bytes = md5_palette_bytes", VK_ENTITY)
        ...
        self.assertIn(".offset = frame->md5_palette_offset,", VK_ENTITY)
