#!/usr/bin/env python3
"""Generate a dense inline-BSP grid with authored per-face lightmaps."""
...
MAP_NAME = "worr_fr01_bmodel_instances_lightmapped.bsp"
# gl_modulate=2 in the deterministic capture setup makes this near-identity
# lighting, while still forcing both renderers through the static-lightmap
# submission path.
BMODEL_LIGHTMAP_RGB = (128, 128, 128)
...
def main() -> int:
    ...
    report = {
        "schema": "worr.renderer-parity.bmodel-lightmapped-instance-fixture.v1",
    ...
    print(
        ...
        f"{len(outputs)} lightmapped bmodel-instancing fixture output(s)"
    )
    return 0
